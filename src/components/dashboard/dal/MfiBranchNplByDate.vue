                ...
                <b-row>
                    <b-col class="c" cols="3">
                        <b-form-select
                            size="sm"
                            :plain="true"
                            :options="ratingDatelist"
                            @change.native="onChangeRatingDate($event)"
                            v-model="ratingDate">
                        </b-form-select> 
                    </b-col>
                </b-row>
...
<script src="@/components/services/dashboard/dal/MfiBranchNplByDate.js"></script>