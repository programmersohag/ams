...
<b-row>
    <b-col lg="12">
        <div class="logo-container">
            <div class="logo-img float-left">
                <img src="img/MF360Next_No_Text.png" class="logo animation-logo" />
            </div>
            <div class="text-features float-left">
                <p style="margin-bottom:0px"><span class="title-360">MicroFin<span class="red">3</span><span class="green">6</span><span class="yellow">0</span></span></p>
                <p class="text-tagline"><span class="invisible">NEXT-Gen In Digital Financial Inclusion</span></p>
            </div>
            <div class="svg-container float-left">
    ...
    <b-col lg="12">
            ...
            <div class="service-name text-rolling">
              <span class="word blue">All Service</span>
...
<script>
import SvgIcon from '@/containers/ui/SvgIcon';
export default {
    name: "Logo",
    omponents:{
        SvgIcon
    ...
    mounted() {
        ...
        if(nw.length > 0) {
            for (var i = 0; i < nw.length; i++) {
                ...
                nw[i].style.position = 'relative';
                nw[i].style.transformOrigin = '50% 50% 25px';
        ...
        if(currentWord == wordArray.length-1){
            ...
            var textService = document.querySelectorAll('.service-name>span');
            textService[0].classList.remove('invisible');
            var textTagline = document.querySelectorAll('.text-tagline span');
        ...
        function animateLetterOut(cw, i) {
            setTimeout(() => {
                    ...
                    cw[i].style.display = 'inline-block';
                    cw[i].style.position = 'relative';
                    cw[i].style.transformOrigin = '50% 50% 25px';
                    cw[i].style.transform = 'rotateX(-90deg)';
                    cw[i].style.transition = 'transform 0.32s cubic-bezier(0.55, 0.055, 0.675, 0.19)';
        ...
        function animateLetterIn(nw, i) {
            setTimeout(() => {
                    ...
                    nw[i].style.transition = 'transform 0.38s cubic-bezier(0.175, 0.885, 0.32, 1.275)';
        ...
        function splitLetters(word) {
            ...
            for (var i = 0; i < content.length; i++) {
               ...
               // letter.className = 'letter';
                ...
                letter.style.transformOrigin = '50% 50% 25px';
                letter.style.transform = 'translateZ(25px)';
...
.text-features .title-360{
    font-size: 30px;
    margin-top: 2px;
    display: block;
    line-height: 30px;
}
.text-features .text-tagline{
    font-size: 10px;
    margin-bottom: 0px;
}
.svg-container{
...
div.logo img {width: 252px;height: 65px;}
div.service-name{
    margin-top: 35px;
    margin-bottom: 35px;
    overflow: hidden;
