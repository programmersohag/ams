        ...
        <div class="search">
          <fieldset>
            ...
            <b-form inline @submit.prevent="handleSubmit" autocomplete="off">
              ...
              <b-button type="submit"  variant="primary" size="sm"><i class="fa fa-search fa-sm"></i>&nbsp;{{ $t("update") }}</b-button>&nbsp;
...
<script src="@/components/services/admin/admin_actions/ChangeNonPrimaryLoanProducts.js"></script>
