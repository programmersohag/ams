    ...
    <b-row>
      <b-col xs="12" lg="12">
        ...
        <b-card v-if="isMfiAudit">
          ...
          <div class="table-responsive">
            <table border="1">
              ...
              <tbody>
              <tr v-for="(item, index) in processedApiData" :key="index">
                <td>
                  <table>
                    <tr>
                    ...
                    <tr>
                      <td>Closing Previous Financial Year</td>
                      <td>:</td>
                      <td>{{ item['closingPreviousFinancialYear'] }}</td>
                    </tr>
                    <tr>
                      <td>This Year Target</td>
                      <td>:</td>
                      <td>{{ item['thisYearTarget'] }}</td>
                    </tr>
                    <tr>
                      <td>Up To This Month Target</td>
                      <td>:</td>
                      <td>{{ item['upToThisMonthTarget'] }}</td>
                    </tr>
                    <tr>
                      <td>This Month Target</td>
                      <td>:</td>
                      <td>{{ item['thisMonthTarget'] }}</td>
                    </tr>
                    <tr>
                      <td>Previous Month Achievement</td>
                      <td>:</td>
                      <td>{{ item['prevMonthAchievement'] }}</td>
                    </tr>
                    <tr>
                      <td>Up To This Month Achievement</td>
                      <td>:</td>
                      <td>{{ item['upToThisMonthAchievement'] }}</td>
                    </tr>
                    <tr>
                      <td>This Month Achievement</td>
                      <td>:</td>
                      <td>{{ item['thisMonthAchievement'] }}</td>
                    </tr>
                  </table>
                </td>
                <td>
        ...
        <b-card>
          ...
          <div class="table-responsive">
            <CommonIndex
              :table_data="target_and_achievements"
...
<script src="@/components/services/audit_executions/target_and_achievements/Add.js"></script>
