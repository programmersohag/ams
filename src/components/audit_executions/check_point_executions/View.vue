<template>
  <div>
    ...
    <b-card>
      ...
      <div v-for="(items, category) in groupedCheckListExecutionItems">
        <h5>Check List Category: {{ category }}</h5>
...
<script src="@/components/services/audit_executions/check_point_executions/View"></script>
<style scoped>
