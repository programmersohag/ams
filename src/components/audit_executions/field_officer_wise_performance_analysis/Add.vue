  ...
  <div class="animated fadeIn entry-list">
    ...
    <b-row>
      <b-col xs="12" lg="12">
        ...
        <b-form @submit.prevent="handleSubmit()" autocomplete="off" v-if="is_form_load">
          <b-card>
            <FormGenerator
              :schema="schema"
              :formValue="form_data"
        ...
        <b-card v-if="isMfiAudit">
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
              <tr v-for="(item, index) in corePerformanceAnalysis" :key="index">
                <td>
                  <table>
                    <tr>
                      <td>Name</td>
                    ...
                    <tr>
                      ...
                      <td>:</td>
                      <td>{{ item['currentDueLoan'] }}</td>
                    </tr>
                    <tr>
                      <td>Total Due Loan</td>
                      <td>:</td>
                      <td>{{ item['totalDueLoan'] }}</td>
                    </tr>
                    <tr>
                      <td>Current Due Balance</td>
                      <td>:</td>
                      <td>{{ item['currentDueBalance'] }}</td>
                    </tr>
                    <tr>
                  ...
                  <table>
                      ...
                      <td>
                        ...
                        >
                          <b-form-select :options="satisfactionRatios" v-model="item.satisfactionRatio"
                                         :name="'satisfactionRatio[' + index + ']'"  v-validate="'required'" data-vv-as="satisfaction ratio"
                    ...
                    <tr>
                      ...
                      <td>
                        <b-form-group
                        >
                          <b-form-select :options="riskLevels" v-model="item.riskLevel" :name="'riskLevel[' + index + ']'" v-validate="'required'"
                                         data-vv-as="risk level" @change.native="onChangeRl($event, item.index)"></b-form-select>
        ...
        <b-card>
          ...
          <div class="table-responsive">
            <CommonIndex
              :table_data="performanceAnalysis"
...
<script src="@/components/services/audit_executions/field_officer_wise_performance_analysis/Add.js"></script>
