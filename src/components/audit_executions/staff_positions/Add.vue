        ...
        <b-card v-if="isMfiAudit">
          ...
          <div class="table-responsive">
            <table class="table table-bordered">
              ...
              <tbody>
              <tr v-for="(item, index) in core_staff_positions" :key="index">
                <td>
                  <table>
                    <tr>
                      <td>Name</td>
                    ...
                    <tr>
                      <td>organization Joining Date</td>
                      <td>:</td>
                      <td>{{ item['organizationJoiningDate'] }}</td>
                    </tr>
                    <tr>
                      <td>Branch Joining Date</td>
                      <td>:</td>
                      <td>{{ item['branchJoiningDate'] }}</td>
                    </tr>
                    <tr>
                      <td>Address</td>
                      <td>:</td>
...
<script src="@/components/services/audit_executions/staff_positions/Add.js"></script>
