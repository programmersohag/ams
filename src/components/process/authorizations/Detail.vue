    ...
    <div class="animated fadeIn entry-list">
        <b-row>
            <b-col xs="12" lg="12">
                ...
                <b-card>
                    <div slot="header">
                        <h5><i class="fa fa-th-list fa-sm"></i>&nbsp;{{ $t("samity")+" "+$t('wise')+" "+$t('transaction')+" "+$t('authorization')+" "+$t('detail') }} As on {{current_date}}</h5>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-action">
                                            ...
                                            <b-button
                                                id="Addbtn"
                                                title="Add"
                                                @click.prevent="singleAuthorize(row.member_id, row.samity_id)"
                                                size="sm"
                                                variant="primary"
                                                class="mr-1 btnpad">
                                                {{ $t("authorize") }}
                    ...
                    <div class="text-right" slot="footer" v-if="Object.keys(transaction_authorizations_detail).length > 0">
...
<script src="@/components/services/process/authorizations/Detail.js"></script>
