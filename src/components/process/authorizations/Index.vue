    ...
    <div class="animated fadeIn entry-list">
        <b-row>
            <b-col xs="12" lg="12">
                ...
                <b-card>
                    <div slot="header">
                        <h5><i class="fa fa-th-list fa-sm"></i>&nbsp;{{ $t("transaction_authorization") }} As on {{current_date}}</h5>
                    </div>
                        ...
                        <table class="table table-bordered report-table" v-else>
                            ...
                            <tbody>
                                <tr v-for="(row, key, index) in transaction_authorizations" :key="key">
                                    ...
                                    <td v-if="is_SKT_required == 1">{{row.skt_collection_amount}}</td>
                                    <td v-if="is_SKT_required == 1">{{row.skt_withdraw_amount}}</td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-action">
                                            ...
                                            <b-button
                                                id="Addbtn"
                                                title="Add"
                                                @click.prevent="singleAuthorize(row.samity_id)"
                                                size="sm"
                                                variant="primary"
                                                class="mr-1 btnpad">
                                                {{ $t("authorize") }}
                            ...
                            <tfoot>
                                <th colspan="3" class="text-center">{{totalVal.total}}</th>
                    ...
                    <div class="text-right" slot="footer" v-if="Object.keys(transaction_authorizations).length > 0">
...
<script src="@/components/services/process/authorizations/Index.js"></script>
