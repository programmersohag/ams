      ...
      <b-card-group deck>
        <b-card>
          ...
          <div class="row">
            ...
            <b-col sm="8">
              <h7><strong>{{ inputForm.txt_audit_period }}</strong></h7>
            </b-col>
          </div>
          <div class="row">
            <b-col sm="4">
            ...
            <b-col sm="8">
              <h7><strong>{{ inputForm.txt_audit_area }}</strong></h7>
            </b-col>
          </div>
          <div class="row">
            <b-col sm="4">
            ...
            <b-col sm="8">
              <h7><strong>{{ inputForm.txt_purpose }}</strong></h7>
            </b-col>
          </div>
          <div class="row">
            <b-col sm="4">
            ...
            <b-col sm="8">
              <h7><strong>{{ inputForm.txt_limitation_of_audit }}</strong></h7>
            </b-col>
          </div>
        </b-card>
        <!-- Start Review Reply -->
...
<script src="@/components/services/process/audit_reply/reply_GI.js"></script>
