<template>
  <div class="animated fadeIn entry-list">
    <b-card>
      <div slot="header">
        <h5><i class="fa fa-th-list fa-sm"></i>&nbsp;Check Point Execution</h5>
      </div>
      <b-col xs="12" lg="12">
        ...
        <div class="table-responsive">
          <CommonIndex
            :table_data="check_point_executions"
...
<script src="@/components/services/process/audit_review/review_CP.js"></script>
<style scoped>
