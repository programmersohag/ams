        ...
        <b-row>
          <b-col sm="6">
            ...
            >
              ...
              <form-error :message="errors.first('txt_comment') || errorMessage['txt_comment']"></form-error>
            </b-form-group>
            <b-form-group
              label-size="sm"
...
<script src="@/components/services/process/corrective_action_tools/cat_CP.js"></script>
<style>
