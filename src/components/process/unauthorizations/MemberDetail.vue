    ...
    <div class="animated fadeIn entry-list">
        <b-row>
            <b-col xs="12" lg="12">
                <b-card>
                    <div slot="header">
                        <h5><i class="fa fa-th-list fa-sm"></i>&nbsp;{{ $t("member")+" "+$t('wise')+" "+$t('transaction')+" "+$t('unauthorization')+" "+$t('detail') }} As on {{current_date}}</h5>
                        <mf-button :btnType="'back'" :btnClass="'float-right'" />
                    </div>
                    <div class="table-responsive">
                        <table class="table table-bordered no-record-found" v-if="Object.keys(unauthorization_detail_member_wise).length == 0">
                            <thead>
                                <tr>
                        ...
                        <table class="table table-bordered report-table" v-else>
                            ...
                            <tbody>
                                <tr v-for="(row, key) in unauthorization_detail_member_wise" :key="key">
                    ...
                    <div slot="footer" class="text-right" v-if="Object.keys(unauthorization_detail_member_wise).length > 0">
...
<script src="@/components/services/process/unauthorizations/MemberDetail.js"></script>