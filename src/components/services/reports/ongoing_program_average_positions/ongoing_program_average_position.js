...
export default {
  name: "ongoing_program_average_position",
  components: {
    SearchFormGenerator,
    ReportContainer
  },
  data() {
    return {
      user: {},
      params: {title: 'Target And Achievement Report', url: '', data: null},
      error_message: [],
      SearchSchema: {
        txt_location: {
  ...
  methods: {
    getReport: function () {
      const fileName = 'average-position-of-ongoing-program'
      const url = 'average-position-of-ongoing-programs'
