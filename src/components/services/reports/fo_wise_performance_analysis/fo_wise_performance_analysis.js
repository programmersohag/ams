...
export default {
  ...
  data() {
    return {
      user: {},
      params: {title: 'Field Officer wise Performance Analysis Report', url: '', data: null},
      error_message: [],
      SearchSchema: {
        txt_location: {
  ...
  methods: {
    getReport: function () {
      const fileName = "fo-wise-performance-analysis";
      const url = "fo-wise-performance-analysis";
